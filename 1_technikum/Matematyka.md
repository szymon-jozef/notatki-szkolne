...
$$
\begin{align}
\sqrt[2]{a} = \sqrt{a} &= a^{\frac{1}{2}} \text{, gdzie } a \text { nie może być ujemne!!!} \\ 
\text{np.} \\
\sqrt{4} = 2 \text{, bo }2^2 &= 4 \\
\sqrt{9} = 3 \text{, bo }3^2 &= 9 \\
\sqrt{16} = 4 \text{, bo }4^2 &=  16\\
\end{align}
$$
### Definicja pierwiastka 3-ciego stopnia
$$
\begin{align}
\sqrt[3]{a} = a^{\frac{1}{3}} \\
\text{np.} \\
